...
sap.m.App.prototype.onBeforeRendering=function(){jQuery.sap.initMobile({homeIcon:this.getHomeIcon()})};
...
sap.m.App.prototype.setBackgroundOpacity=function(o){if(o>1||o<0){jQuery.sap.log.warning("Invalid value "+o+" for App.setBackgroundOpacity() ignored. Valid values are: floats between 0 and 1.");return this}jQuery.sap.byId(this.getId()+"-BG").css("opacity",o);return this.setProperty("backgroundOpacity",o,true)};
