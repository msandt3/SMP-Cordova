...
sap.m.Text.prototype.setText=function(t){this.setProperty("text",t,true);var d=this.getDomRef();if(d){d.textContent=t}return this};
sap.m.Text.prototype.onBeforeRendering=function(){this._cleanupResize()};
sap.m.Text.prototype.onAfterRendering=function(){if(this.getWrapping()&&this.getMaxLines()>1&&!sap.m.Text.hasNativeLineClamp){this._$text=this.$();if(sap.m.Text._isFontLoaded){this._clampText()}else{this._clampHeight()}this._registerResize()}};
