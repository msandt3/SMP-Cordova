...
sap.m.Tile.prototype.ontouchstart=function(){if(!this.isEditable()&&!this._parentPreventsTapEvent){this.$().toggleClass("sapMTileActive sapMTileActive-CTX",true)}};
...
sap.m.Tile.prototype.ontouchmove=function(){if(!this.isEditable()&&!this._parentPreventsTapEvent){this.$().toggleClass("sapMTileActive sapMTileActive-CTX",false)}};
