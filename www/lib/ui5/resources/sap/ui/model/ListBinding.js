 ...
 */
jQuery.sap.declare("sap.ui.model.ListBinding");jQuery.sap.require("sap.ui.model.Binding");jQuery.sap.require("sap.ui.model.Sorter");jQuery.sap.require("sap.ui.model.Filter");sap.ui.model.Binding.extend("sap.ui.model.ListBinding",{constructor:function(m,p,c,s,f,P){sap.ui.model.Binding.call(this,m,p,c,P);this.aSorters=s;if(!jQuery.isArray(this.aSorters)&&this.aSorters instanceof sap.ui.model.Sorter){this.aSorters=[this.aSorters]}else if(!jQuery.isArray(this.aSorters)){this.aSorters=[]}this.aFilters=f;if(!jQuery.isArray(this.aFilters)&&this.aFilters instanceof sap.ui.model.Filter){this.aFilters=[this.aFilters]}else if(!jQuery.isArray(this.aFilters)){this.aFilters=[]}this.aApplicationFilters=[];this.bUseExtendedChangeDetection=false},metadata:{"abstract":true,publicMethods:["getContexts","sort","attachSort","detachSort","filter","attachFilter","detachFilter","getDistinctValues","isGrouped"]}});
