...
sap.ui.model.ContextBinding.prototype._refresh=function(){var t=this;this.fireDataRequested();this.oModel.createBindingContext(this.sPath,this.oContext,this.mParameters,function(c){t.oElementContext=c;t._fireChange();t.fireDataReceived()},true)};
