...
jQuery.sap.declare('sap.apb.makit.library-all');
if ( !jQuery.sap.isDeclared('sap.apb.makit.ChartRenderer') ) {
/*!
 * @copyright@
 */
...
}; // end of sap.apb.makit.ChartRenderer
if ( !jQuery.sap.isDeclared('sap.apb.makit.library') ) {
/* -----------------------------------------------------------------------------------
...
}; // end of sap.apb.makit.library
if ( !jQuery.sap.isDeclared('sap.apb.makit.Chart') ) {
/* ----------------------------------------------------------------------------------
 * Hint: This is a derived (generated) file. Changes should be done in the underlying 
